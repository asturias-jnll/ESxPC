...
class HomePage:
    def __init__(self, root):
        ...
        self.form_button = ttk.Button(self.sidebar_frame, text="Rice Details", command=self.display_rice_form, style='Sidebar.TButton')
    ...
    def open_ricetracker(self):
        ...
        ricetracker_display.ricetracker_records()
    ...
    def display_home(self):
        ...
        #Size
        resized_image = original_image.resize((1000, 250))  #width at height
        ...
        info_text = """
        Magtanim ay 'di biro itong nararamdaman ko sa'yo. Yieeeeeee.
        """
    ...
    def display_info(self):
        ...
        #Size
        resized_image = original_image.resize((1000, 270))
        ...
        #Text sa baba ng image
        info_text = """
        Maghapong nakayuko. 'Di man lang ako mahalin pabalik. Aww. Meow Meow.
        """
...
class RiceTracker(HomePage):
    ...
    def ricetracker_records(self):
        ...
        self.tree.column("Type of Rice", width=150)  
        self.tree.column("Quantity of Seeds (in sacks)", width=45)  
        self.tree.column("Date Planted", width=40)
        self.tree.column("Estimated Date of Harvest", width=55)
        self.tree.column("Harvested Rice (in kg)", width=30)
        self.tree.column("Rice Sold (in kg)", width=155)
        self.tree.column("Stocks", width=85)
        self.tree.column("Sales", width=140)
    ...
    def show_highsales_rice(self):
        ...
        if rice:
            ...
            # column widths
            column_widths = [20, 150, 45, 40, 55, 30, 155, 85, 140]
